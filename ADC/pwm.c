 ...
 * Name: initPWM
 * 
 * Description:  initPWM initialises the timer A0 which is used to
 ...
 * 
 * Return: currently, it is broke. So nothing in return :(
 * 
 * 
 * Author: Iakov Umrikhin
 * 
...
void setPWM(unsigned int dutyCycle, unsigned int frequency) {
    ...
    TA1CCR1 = (TA1CCR0 + 1) * (double)dutyCycle * 0.01;  // The duty cycle is a percentage of the main timer's period
